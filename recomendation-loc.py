...
location_recommender_tf.load_model("Search_location.h5")

# Penggunaan untuk mencari rekomendasi tempat wisata baru setelah memuat model
new_place_name = "Ngarai Sianok"
recommendations_new_place = location_recommender_tf.recommend_by_place_name(new_place_name)
if recommendations_new_place is not None:
    recommendations_new_place
recommendations_new_place
