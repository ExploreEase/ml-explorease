...
# Memuat kembali model dan rekomendasi yang terkait
user_coordinates_new = (-6.1752, 106.8273)
user_category_new = 'Bahari'  # Ganti dengan kategori yang diinginkan

# Menggunakan metode load_model_with_recommendations untuk memuat model dan rekomendasi
location_recommender_tf.load_model_with_recommendations("User_latlong_category.h5", user_coordinates_new, user_category_new)

# Mendapatkan rekomendasi berdasarkan input baru
recommendations_user_new = location_recommender_tf.recommend_nearby_location(user_coordinates_new, user_category_new)
recommendations_user_new
