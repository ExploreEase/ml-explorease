...
location_recommender_tf = LocationRecommenderTensorFlow(dataset_new)
user_coordinates = (-6.1752, 106.8273)
loaded_recommendations = location_recommender_tf.load_model_with_recommendations("Top_destination.h5", user_coordinates)

if loaded_recommendations is not None:
    print("Recommendations after loading the model:")
