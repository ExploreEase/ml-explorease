...
location_recommender_tf.save_model_with_recommendations("Nearby_treasure.h5")
recommendations_user


# Setelah memuat model
location_recommender_tf = LocationRecommenderTensorFlow(dataset_new)
location_recommender_tf.load_model_with_recommendations("Nearby_treasure.h5")

# Penggunaan untuk mencari rekomendasi tempat wisata berdasarkan koordinat baru
new_user_coordinates = (-6.1752, 106.8273)
new_recommendations = location_recommender_tf.recommend_nearby_location(new_user_coordinates)
